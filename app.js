...
const alpha2Template =
    `// Code generated by github.com/mikekonan/go-countries@generator. DO NOT EDIT.
package country

const (
${
        codes.map(code => `${code.a2.key} = Alpha2Code("${code.a2.value}")`)
            .join('\n')}
) 
`;

const alpha3Template =
    `// Code generated by github.com/mikekonan/go-countries@generator. DO NOT EDIT.
package country

const (
${
        codes.map(code => `${code.a3.key} = Alpha3Code("${code.a3.value}")`)
            .join('\n')}
) 
`;
...
const countryByCountryTemplate =
    `// Code generated by github.com/mikekonan/go-countries@generator. DO NOT EDIT.
package country
